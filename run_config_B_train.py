"""
保存位置: Anla/run_config_B_train.py
...
用法:
    python -m Anla.run_config_B_train
...
OUTPUT_DIR = os.path.join("Logs", "config_B_analysis")
...
def main():
    ...
    from Anla.capacity_pressure_test_v4 import main as train_main
    train_main()
    ...
    print()
    print("  下一步: 运行可视化脚本")
    print("    python -m Anla.visualize_config_B")
    print("=" * 72)
