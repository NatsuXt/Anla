"""
保存位置: Anla/visualize_config_B.py
Config B 全量可视化分析
用法:
    python -m Anla.visualize_config_B
    python -m Anla.visualize_config_B --data-dir Logs/config_B_analysis/config_B_v256_d64
"""
...
def reconstruct_model(checkpoint, device="cpu"):
    try:
        import torch
        from Anla.capacity_pressure_test_v4 import AnlaManifoldInpainter
...
def main():
    ...
    parser.add_argument("--data-dir", type=str, default=os.path.join("Logs", "config_B_analysis", "config_B_v256_d64"))
